...
import MicroDataFAQ from "@/grandus-lib/components-atomic/microData/MicroDataFaq";
...
export const MICRODATA_FAQ = "faq"
...
const MicroData = ({ type = "default", data = null }) => {
  ...
  switch (type) {
    ...
    case MICRODATA_FAQ:
      return <MicroDataFAQ webInstance={webInstance} data={data}/>;
    default:
      return null;
  }
};
